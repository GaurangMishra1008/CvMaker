            ...
            <div class="row">
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_text">
                     <div class="galleryh3">
                        <h3>These are some</h3>
                        <p><h3>Resume We Created</h3>
                         <h3> With Love</h3> 
                         <p><img src="images/heart.png" style="height: 150px"/></p>
                          <br>
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="images/resume2.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="images/resume3.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_text">
                     <div class="galleryh3">
                        <h3>All are Our Premium work </h3>
                        <p><br>
                          <br>
                           <h3>Get Subscription for Premium Work</h3>
                           <p><img src="images/crown.png" style="height: 150px"/></p>
                        </p>
                     </div>
                  </div>
               </div>
